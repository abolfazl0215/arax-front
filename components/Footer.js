/**
 * Footer Component
 * Contains navigation links, social media, and company information
 */
...
export default function Footer() {
  return (
    <footer className="bg-slate-200">
      <div className="container md:px-[16vw] px-4 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-gray-300 text-center text-gray-600">
          <p>© All rights reserved. Arax Company.</p>
        </div>
      </div>
    </footer>
  );
